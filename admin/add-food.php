        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                <tr>
                    <td>Title:</td>
                    <td>
                        <input type="text" name="title" placeholder="title of the exam">
                    </td>
                </tr>
                <tr>
                    <td>Description:</td>
                    <td>
                        <textarea name="description" cols="30" rows="5" placeholder="description of the exam"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>Difficulty:</td>
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Add Exam" class="btn-secondary">
                    </td>
                </tr>
            </table>
        </form>
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                if($res==true)
                {
                    ...
                    $_SESSION['add']="<div class='success'>Exam ADDED Succesfully</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }
                else
                {
                    //failed to insert data
                    $_SESSION['add']="<div class='error'>failed to add exam</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
